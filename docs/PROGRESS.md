...
| Paris | 2026-06-06 ~ 2026-06-10 | 📝 Needs Review | 31 | 16 | 1 | 2026-03-28 | 將 Maison Pichard（88 Rue Cambronne）註記為永久歇業（保留條目避免重複研究誤納入），並在 UI 載入時排除 `is_closed: true`。本輪續研將 Merci Jérôme（66 Avenue de la Motte-Picquet）補齊多來源驗證並升級為 `ready`。 |
