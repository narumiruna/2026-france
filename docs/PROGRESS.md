...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Avignon | 2026-05-30 ~ 2026-06-02 | 📝 Needs Review | 20 | 11 hotel_nearby | 0 | 2026-03-31 | 補強 4 家來源並升級 `confirmed`；修正 Cuisine Centr'Halles 名稱/地址、L'Atelier de Belinda 地址（48→17 Place des Corps Saints）；確認 4 家均未入 Michelin/Le Fooding。 |
| Nice | 2026-06-02 ~ 2026-06-05 | 📝 Needs Review | 31 | 15 hotel_nearby | 0 | 2026-03-30 | 新增 10 筆飯店附近（hotel_nearby）候選，覆蓋 Quartier Libération 各餐食時段：La Route du Miam（Tripadvisor 4.8/5，西南法晚餐）、Brasserie Le Gambetta（每日午晚，海鮮/小館）、Restaurant L'Instant（bistronomique，Travelers' Choice）、Braise（木火碳烤，深夜營業）、À la Table du Marché（市場料理）、La Femme du Boulanger（全日早午餐）、Panivore（外帶早餐）、Chez Les Garçons（復古早午餐）、La Brioche Chaude（每日烘焙）、Le Bonjour（在地小館）；hotel_nearby 共計 15 筆。 |
...
## 更新紀錄
- 2026-03-31: Avignon 4 家 `researching` 餐廳補強權威來源，全部升級 → `confirmed`，並修正關鍵名稱與地址錯誤：
