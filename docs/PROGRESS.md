...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Avignon | 2026-05-30 ~ 2026-06-02 | ✅ Completed | 23 | 13 hotel_nearby | 1 歇業 | 2026-05-07 | Maison Violette 補齊官方、Gault&Millau、Petit Futé、Tripadvisor、Restaurant Guru 來源，升級 `ready` 並同步入 `data/restaurants.json`；Pavillon 84 維持歇業保留。 |
