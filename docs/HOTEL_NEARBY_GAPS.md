...
description: 追蹤每個住宿點附近餐廳與咖啡廳候選是否達到 100 間門檻。
---

# 住宿附近候選缺口

本文件只追蹤「每個住宿地點附近至少 100 間可用餐廳或咖啡廳」的達標狀態與維護要求。進度狀態仍以 [PROGRESS.md](./PROGRESS.md) 為準，資料驗證以 `node scripts/verify-hotel-nearby-counts.mjs` 為準。
...
- 每站達到 `100/100` 前，不得把住宿周邊研究標記為完成。

## 目前缺口

| 城市 | 住宿點 | 目前可用數 | 仍缺 | 補齊狀態 |
| --- | --- | ---: | ---: | --- |
| Avignon | ibis Avignon Centre Pont de l'Europe | 100/100 | 0 | 已補齊；新增外查候選集中於住宿周邊、舊城核心、Rue de la République、Cours Jean Jaurès 與 Avignon 延伸動線。 |
| Nice | ibis Nice Centre Notre-Dame | 100/100 | 0 | 已補齊；新增外查候選集中於 Rue Lamartine、Jean Médecin、Rue Assalit、Nice-Ville、Libération 與 Vieux Nice 延伸動線。 |
| Mont Saint-Michel | Hôtel Gabriel | 100/100 | 0 | 已補齊；外圍動線定義為 La Caserne、Beauvoir、島內進島動線、Pontorson 與 Avranches 短程車程 / 轉乘備案。 |
| Paris | ibis Paris Tour Eiffel Cambronne 15ème | 100/100 | 0 | 已補齊；新增外查候選集中於 Cambronne、La Motte-Picquet、Commerce、Ségur 與左岸南側。 |
...
## 本地候選池稽核
- 以下為 2026-05-15 將門檻提高到 50 間時的歷史稽核；2026-05-29 的 100 間門檻已改用新一輪外部 OSM/Overpass 匯入補齊。
